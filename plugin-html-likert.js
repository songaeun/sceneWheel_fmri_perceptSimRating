var jsPsychHtmlLikert = (function (jspsych) {
  'use strict';
          ...
          questions: {
              ...
              nested: {
                  ...
                  left_stim: {
                      ...
                      pretty_name: "stimulus on left side.",
                      default: undefined,
                  },
                  right_stim: {
                    type: jspsych.ParameterType.STRING,
                    pretty_name: "stimulus on right side.",
                    default: undefined,
                },
  ...
  class SurveyLikertPlugin {
      ...
      trial(display_element, trial) {
          ...
          for (var i = 0; i < trial.questions.length; i++) {
              ...
              // add image
              html += '<img style="padding:30px;" src="'+question.left_stim+'" id="jspsych-image-button-response-stimulus">';
              console.log(question.left_stim)
              html += '<img style="padding:30px;" src="'+question.right_stim+'" id="jspsych-image-button-response-stimulus">';
              // add question
